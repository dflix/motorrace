                                    ...
                                    <div class="row">
                                        <div class="col-lg-6"> 
                                            ...
                                            <select name="carteira_id" class="form-control"> 
                                                ...
                                                $carteira->ExeRead("app_carterias", "ORDER BY id DESC");
                                                $carteira->getResult();
                                                foreach ($carteira->getResult() as $forcarteira):
                                                    ?>
...
?>
                            ...
                            <input type="date" id="date" name="start"  class="form-control input-datepicker" />
                            Fim

                            <input type="date" id="date" name="end"  class="form-control input-datepicker" />
...
$cat->ExeRead("app_categorias", "WHERE type = :r", "r=despesa");
$cat->getResult();
...
$pager = new \Source\Support\Pager('?p=saidas&atual=', 'Primeira', 'Ultima', '1');
